...
const Cards = () => {
    return (<>
      ...
      <h3 className='text-2xl text-blue-900 text-center' id='texth'>Axzons is a Lead CDPAP Provider and Licensed Home Health Care Agency</h3>
          <div className='grid grid-cols-3 gap-3 justify-center  items-center xs:grid-cols-1 xs:mr-25 xs:ml-5 text-center' id='row1'>
     ...
     <p>Axzons Homecare offers highly trained, professional Caregivers to assist your loved one around the clock..</p>
      <button className='text-center grid justify-items-center' id='btn1'>Read more</button>
          ...
          <div className='grid grid-cols-3 gap-3 justify-center  items-center mt-10 xs:grid-cols-1 xs:mr-25 xs:ml-5 text-center' id='row1' >
          <div className="" id='cardno1' data-aos="zoom-in-up" data-aos-duration="1000">
