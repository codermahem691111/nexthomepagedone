...
const Sec3 = () => {
   ...
   return (<>
          <h3 className='text-2xl text-center text-cyan-950'> Smiles are true testimonials!</h3>
          <div className='flex flex-row justify-center items-center xs:flex-col' id='maincon'>
           ...
           <div className=' flex flex-col p-10' id='textcontainer2'>
             ...
             <div className='flex flex-row mt-5 xs:flex-col' id='icondiv1'>
                <div className='flex flex-row '  data-aos="fade-up-right" id='subicondiv'>
                   <FaUserDoctor className='text-3xl text-blue-900'/>
                   <h3 className='text-xl text-cyan-950 '>Quality Care</h3>
                </div>
                <div className='flex flex-row ml-5 xs:ml-0 xs:mt-5'  data-aos="fade-up-right" id='subicondiv'>
                   <FaUserNurse className='text-3xl text-blue-900'/>
                   <h3 className='text-xl text-cyan-950 '>Quality Care</h3>
                </div>
             </div> 
             <div className='flex flex-row mt-5 xs:flex-col'  data-aos="fade-up-right" id='icondiv2'>
